...
import com.xiezongnan.gen.codegen.constant.GenTypeConst;
import com.xiezongnan.gen.codegen.generator.GeneratorFactory;
import com.xiezongnan.gen.codegen.template.ITemplate;
import com.xiezongnan.gen.codegen.template.impl.EnjoyTemplate;
...
public class TemplateConfig {
    ...
    public String getDto() {
        return GeneratorFactory.getGenerator(GenTypeConst.DTO).getTemplatePath();
    }
    ...
    public TemplateConfig setDto(String dto) {
        GeneratorFactory.getGenerator(GenTypeConst.DTO).setTemplatePath(dto);
        return this;
    }
     ...
     */
    public String getVo() {
        return GeneratorFactory.getGenerator(GenTypeConst.VO).getTemplatePath();
    }
    ...
    public TemplateConfig setVo(String vo) {
        GeneratorFactory.getGenerator(GenTypeConst.VO).setTemplatePath(vo);
        return this;
    }

    /**
     * 获取生成 MAPSTRUCT 模板文件的位置。
     */
    public String getMapstruct() {
        return GeneratorFactory.getGenerator(GenTypeConst.MAPSTRUCT).getTemplatePath();
    }

    /**
     * 设置生成 MAPSTRUCT 模板文件的位置。
     */
    public TemplateConfig setMapstruct(String vo) {
        GeneratorFactory.getGenerator(GenTypeConst.MAPSTRUCT).setTemplatePath(vo);
        return this;
    }
