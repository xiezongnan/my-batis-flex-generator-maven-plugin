...
import com.xiezongnan.gen.codegen.config.ControllerConfig;
...
public class ControllerGenerator implements IGenerator {
    ...
    public void generate(Table table, GlobalConfig globalConfig) {
        ...
        File controllerJavaFile = new File(packageConfig.getSourceControllerModuleDir(), controllerPackagePath + "/" +
