...
import com.xiezongnan.gen.codegen.template.ITemplate;
...
public class GlobalConfig {
    ...
    private MapstructConfig mapstructConfig;
    ...
    private boolean mapstructGenerateEnable;
    ...
    public MapstructConfig getMapstructConfig() {
        if (mapstructConfig == null) {
            mapstructConfig = new MapstructConfig();
        }
        return mapstructConfig;
    }
    ...
    public MapstructConfig enableMapstruct() {
        mapstructGenerateEnable = true;
        return getMapstructConfig();
    }
    ...
    public void disableMapstruct() {
        mapstructGenerateEnable = false;
    }
    ...
    /**
     * @see PackageConfig#getMapstructPackage()
     */
    public String getMapstructPackage() {
        return getPackageConfig().getMapstructPackage();
    }

    /**
     * @see PackageConfig#setMapstructPackage(String)
     */
    public void setMapstructPackage(String mapstructPackage) {
        getPackageConfig().setMapstructPackage(mapstructPackage);
    }
    ...
    /**
     * @see DtoConfig#isOverwriteEnable()
     */
    public boolean isDtoOverwriteEnable() {
        return getDtoConfig().isOverwriteEnable();
    }

    /**
     * @see DtoConfig#setOverwriteEnable(boolean)
     */
    public void setDtoOverwriteEnable(boolean dtoOverwriteEnable) {
        getDtoConfig().setOverwriteEnable(dtoOverwriteEnable);
    }

    /**
     * @see DtoConfig#getClassPrefix()
     */
    public String getDtoClassPrefix() {
        return getDtoConfig().getClassPrefix();
    }

    /**
     * @see DtoConfig#setClassPrefix(String)
     */
    public void setDtoClassPrefix(String dtoClassPrefix) {
        getDtoConfig().setClassPrefix(dtoClassPrefix);
    }

    /**
     * @see DtoConfig#getClassSuffix()
     */
    public String getDtoClassSuffix() {
        return getDtoConfig().getClassSuffix();
    }

    /**
     * @see DtoConfig#setClassSuffix(String)
     */
    public void setDtoClassSuffix(String dtoClassSuffix) {
        getDtoConfig().setClassSuffix(dtoClassSuffix);
    }

    /**
     * @see DtoConfig#getSuperClass()
     */
    public Class<?> getDtoSuperClass() {
        return getDtoConfig().getSuperClass();
    }

    /**
     * @see DtoConfig#setSuperClass(Class)
     */
    public void setDtoSuperClass(Class<?> dtoSuperClass) {
        getDtoConfig().setSuperClass(dtoSuperClass);
    }

    /**
     * @see DtoConfig#getImplInterfaces()
     */
    public Class<?>[] getDtoInterfaces() {
        return getDtoConfig().getImplInterfaces();
    }

    /**
     * @see DtoConfig#setImplInterfaces(Class[])
     */
    public void setDtoInterfaces(Class<?>[] dtoInterfaces) {
        getDtoConfig().setImplInterfaces(dtoInterfaces);
    }

    /**
     * @see DtoConfig#isWithLombok()
     */
    public boolean isDtoWithLombok() {
        return getDtoConfig().isWithLombok();
    }

    /**
     * @see DtoConfig#setWithLombok(boolean)
     */
    public void setDtoWithLombok(boolean dtoWithLombok) {
        getDtoConfig().setWithLombok(dtoWithLombok);
    }
    ...
    /**
     * @see VoConfig#isOverwriteEnable()
     */
    public boolean isVoOverwriteEnable() {
        return getVoConfig().isOverwriteEnable();
    }

    /**
     * @see VoConfig#setOverwriteEnable(boolean)
     */
    public void setVoOverwriteEnable(boolean voOverwriteEnable) {
        getVoConfig().setOverwriteEnable(voOverwriteEnable);
    }

    /**
     * @see VoConfig#getClassPrefix()
     */
    public String getVoClassPrefix() {
        return getVoConfig().getClassPrefix();
    }

    /**
     * @see VoConfig#setClassPrefix(String)
     */
    public void setVoClassPrefix(String voClassPrefix) {
        getVoConfig().setClassPrefix(voClassPrefix);
    }

    /**
     * @see VoConfig#getClassSuffix()
     */
    public String getVoClassSuffix() {
        return getVoConfig().getClassSuffix();
    }

    /**
     * @see VoConfig#setClassSuffix(String)
     */
    public void setVoClassSuffix(String voClassSuffix) {
        getVoConfig().setClassSuffix(voClassSuffix);
    }

    /**
     * @see VoConfig#getSuperClass()
     */
    public Class<?> getVoSuperClass() {
        return getVoConfig().getSuperClass();
    }

    /**
     * @see VoConfig#setSuperClass(Class)
     */
    public void setVoSuperClass(Class<?> voSuperClass) {
        getVoConfig().setSuperClass(voSuperClass);
    }

    /**
     * @see VoConfig#getImplInterfaces()
     */
    public Class<?>[] getVoInterfaces() {
        return getVoConfig().getImplInterfaces();
    }

    /**
     * @see VoConfig#setImplInterfaces(Class[])
     */
    public void setVoInterfaces(Class<?>[] voInterfaces) {
        getVoConfig().setImplInterfaces(voInterfaces);
    }

    /**
     * @see VoConfig#isWithLombok()
     */
    public boolean isVoWithLombok() {
        return getVoConfig().isWithLombok();
    }

    /**
     * @see VoConfig#setWithLombok(boolean)
     */
    public void setVoWithLombok(boolean voWithLombok) {
        getVoConfig().setWithLombok(voWithLombok);
    }
    ...
    public boolean isMapstructGenerateEnable() {
        return mapstructGenerateEnable;
    }

    public void setMapstructGenerateEnable(boolean mapstructGenerateEnable) {
        this.mapstructGenerateEnable = mapstructGenerateEnable;
    }
    /**
     * @see MapstructConfig#isOverwriteEnable()
     */
    public boolean isMapstructOverwriteEnable() {
        return getMapstructConfig().isOverwriteEnable();
    }

    /**
     * @see MapstructConfig#setOverwriteEnable(boolean)
     */
    public void setMapstructOverwriteEnable(boolean mapstructOverwriteEnable) {
        getMapstructConfig().setOverwriteEnable(mapstructOverwriteEnable);
    }

    /**
     * @see MapstructConfig#getClassPrefix()
     */
    public String getMapstructClassPrefix() {
        return getMapstructConfig().getClassPrefix();
    }

    /**
     * @see MapstructConfig#setClassPrefix(String)
     */
    public void setMapstructClassPrefix(String mapstructClassPrefix) {
        getMapstructConfig().setClassPrefix(mapstructClassPrefix);
    }

    /**
     * @see MapstructConfig#getClassSuffix()
     */
    public String getMapstructClassSuffix() {
        return getMapstructConfig().getClassSuffix();
    }

    /**
     * @see MapstructConfig#setClassSuffix(String)
     */
    public void setMapstructClassSuffix(String mapstructClassSuffix) {
        getMapstructConfig().setClassSuffix(mapstructClassSuffix);
    }

    /**
     * @see MapstructConfig#getSuperClass()
     */
    public Class<?> getMapstructSuperClass() {
        return getMapstructConfig().getSuperClass();
    }

    /**
     * @see MapstructConfig#setSuperClass(Class)
     */
    public void setMapstructSuperClass(Class<?> mapstructSuperClass) {
        getMapstructConfig().setSuperClass(mapstructSuperClass);
    }

    /**
     * @see MapstructConfig#getImplInterfaces()
     */
    public Class<?>[] getMapstructInterfaces() {
        return getMapstructConfig().getImplInterfaces();
    }

    /**
     * @see MapstructConfig#setImplInterfaces(Class[])
     */
    public void setMapstructInterfaces(Class<?>[] mapstructInterfaces) {
        getMapstructConfig().setImplInterfaces(mapstructInterfaces);
    }

    public void setGlobalSourceModuleDir(String globalSourceModuleDir) {
        getPackageConfig().setGlobalSourceModuleDir(globalSourceModuleDir);
    }

    public void setSourceEntityModuleDir(String sourceEntityModuleDir) {
        getPackageConfig().setSourceEntityModuleDir(sourceEntityModuleDir);
    }

    public void setSourceDtoModuleDir(String sourceDtoModuleDir) {
        getPackageConfig().setSourceDtoModuleDir(sourceDtoModuleDir);
    }

    public void setSourceVoModuleDir(String sourceVoModuleDir) {
        getPackageConfig().setSourceVoModuleDir(sourceVoModuleDir);
    }

    public void setSourceMapstructModuleDir(String sourceMapstructModuleDir) {
        getPackageConfig().setSourceMapstructModuleDir(sourceMapstructModuleDir);
    }

    public void setSourceMapperModuleDir(String sourceMapperModuleDir) {
        getPackageConfig().setSourceMapperModuleDir(sourceMapperModuleDir);
    }

    public void setSourceTableDefModuleDir(String sourceTableDefModuleDir) {
        getPackageConfig().setSourceTableDefModuleDir(sourceTableDefModuleDir);
    }

    public void setSourceXmlModuleDir(String sourceXmlModuleDir) {
        getPackageConfig().setSourceXmlModuleDir(sourceXmlModuleDir);
    }

    public void setSourceServiceModuleDir(String sourceServiceModuleDir) {
        getPackageConfig().setSourceServiceModuleDir(sourceServiceModuleDir);
    }

    public void setSourceServiceImplModuleDir(String sourceServiceImplModuleDir) {
        getPackageConfig().setSourceServiceImplModuleDir(sourceServiceImplModuleDir);
    }

    public void setSourceControllerModuleDir(String sourceControllerModuleDir) {
        getPackageConfig().setSourceControllerModuleDir(sourceControllerModuleDir);
    }
