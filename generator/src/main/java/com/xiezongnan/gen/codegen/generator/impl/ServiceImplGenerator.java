...
import com.xiezongnan.gen.codegen.config.ServiceImplConfig;
...
public class ServiceImplGenerator implements IGenerator {
    ...
    public void generate(Table table, GlobalConfig globalConfig) {
        ...
        File serviceImplJavaFile = new File(packageConfig.getSourceServiceImplModuleDir(), serviceImplPackagePath + "/" +
